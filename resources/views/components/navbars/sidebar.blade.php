...
<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0 d-flex text-wrap align-items-center" href=" {{ route('dashboard') }} ">
            ...
            <span class="ms-2 font-weight-bold text-white">Gocashit Price Monitoring</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'product-store' ? ' active bg-gradient-primary' : '' }} "
                    href="{{ route('product-store.index') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">table_view</i>
                    </div>
                    <span class="nav-link-text ms-1">Products-Store</span>
                </a>
            </li>
            <li class="nav-item">
    ...
    <div class="sidenav-footer position-absolute w-100 bottom-0 ">
        <div class="mx-3">
            <a class="btn bg-gradient-primary w-100" href="{{ route('product.index') }}" target="_blank">Check Products</a>
        </div>
        <div class="mx-3">
            <a class="btn bg-gradient-primary w-100" href="{{ route('product-store.index') }}" target="_blank">Cashify Products</a>
        </div>
